...
- Two meetings (`meeting_03_missing_resource`, `meeting_05_decision_stagnation`) scored 0% precision/recall — worth prioritizing for prompt or window-size tuning before the next evaluation pass.
